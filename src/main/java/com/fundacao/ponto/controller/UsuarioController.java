...
public class UsuarioController {
    ...
    @GetMapping("{rfid}")
    public UsuarioDTO listarUm(@PathVariable String rfid){ return usuarioService.buscarPorRfid(rfid); }

    @GetMapping("/identificador/{id}")
    public UsuarioDTO listarPorIdentificador(@PathVariable Integer id){ return  usuarioService.buscarPorId(id); }
